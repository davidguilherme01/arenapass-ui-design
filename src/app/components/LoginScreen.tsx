...
export function LoginScreen() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* ── Form card ── */}
      <div className="flex-1 bg-white rounded-t-3xl -mt-8 relative z-10 shadow-2xl px-8 pt-7 pb-10">
        ...
        <div className="flex bg-gray-100 rounded-2xl p-1 mb-5">
          {(['login', 'register'] as Mode[]).map(m => (
            <button
              ...
              className={`flex-1 py-2.5 rounded-xl text-base font-semibold transition-all cursor-pointer ${
                mode === m
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          {mode === 'register' && (
            <div>
              <label className="block text-base font-medium text-gray-700 mb-1.5">Nome completo</label>
          ...
          <div>
            <label className="block text-base font-medium text-gray-700 mb-1.5">E-mail</label>
            <div className="relative">
          ...
          <div>
            <label className="block text-base font-medium text-gray-700 mb-1.5">Senha</label>
            <div className="relative">
          ...
          {mode === 'register' && (
            <div>
              <label className="block text-base font-medium text-gray-700 mb-1.5">Confirmar senha</label>
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 pointer-events-none" />
                <input
          ...
          {error && (
            <div className="flex items-center gap-2 px-3 py-2.5 bg-red-50 border border-red-200 rounded-xl text-base text-red-700" role="alert">
          ...
          {mode === 'login' && (
            <div className="flex justify-end -mt-1">
              <button
                type="button"
                className="text-base text-primary hover:text-primary/70 transition-colors cursor-pointer"
              >
                Esqueceu a senha?
              </button>
            </div>
